...
```{r diamond, echo=FALSE, fig.cap="Diamond concept,fracture healing",out.width="100%"}
knitr::include_graphics("image/Diamond.png")
```
...
```{r gap, echo=FALSE, fig.cap="Gap healing",out.width="100%"}
knitr::include_graphics("image/Gap.png")
```
...
```{r ingrowth, echo=FALSE, warning=FALSE, fig.cap="Bone ingrowth",out.width="100%"}
knitr::include_graphics("image/ingrowth.png")
```
...
```{r secondary, echo=FALSE, fig.cap="Secondary healing",out.width="100%"}
knitr::include_graphics("image/secondary.png")
...
```{r rank, echo=FALSE, warning=FALSE, fig.cap="RANK-RANKL",out.width="100%"}
knitr::include_graphics("image/rank.png")
```
