...
```{r diamond, echo=FALSE, fig.cap="Diamond concept,fracture healing"}
...
```{r gap, echo=FALSE, fig.cap="Gap healing"}
...
```{r ingrowth, echo=FALSE, warning=FALSE, fig.cap="Bone ingrowth"}
...
```{r secondary, echo=FALSE, fig.cap="Secondary healing"}
...
```{r rank, echo=FALSE, warning=FALSE, fig.cap="RANK-RANKL"}
