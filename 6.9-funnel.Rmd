...
```{r funnel1, echo=FALSE, fig.cap="Funnel Plot"}
...
```{r funnel2, echo=FALSE, fig.cap="Assymetric Funnel Plot"}
...
```{r funnel3, echo=FALSE, fig.cap="Outliers, Funnel Plot"}
...
```{r funnel4, echo=FALSE, fig.cap="walking with variance and sd", out.width="80%"}
